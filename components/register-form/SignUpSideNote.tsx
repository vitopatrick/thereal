...
export default function SignUpSideNote() {
  return (
    <div className='flex-1 flex items-center flex-col space-y-6'>
        {/* image */}
        ...
        <h4 className='font-semibold text-xl'>An active community of like-minded,<br/>
wealth-focused individuals.</h4>
    </div>
  )
}
