        ...
        <div className="my-3 space-y-6">
          ...
          <div>
            ...
            <div
              ...
              className="flex justify-between items-center my-2 cursor-pointer border border-orange-500 rounded"
            >
          ...
          <div>
            ...
            <div className="flex justify-between items-center my-2 cursor-pointer border border-orange-500 py-3 px-2 rounded">
          ...
          <div>
            ...
            <div className="flex border border-orange-500 items-center py-3 px-2 rounded">
              <DollarSign />
              <input
                type="number"
                name="amount"
          ...
          <button
            onClick={openModal}
            className="bg-orange-600 w-full text-white shadow rounded px-4 py-2"
          >
            Withdraw
          </button>
      ...
      >
        <div className="w-[50%] mx-auto p-4 relative">
          <div className=" p-4 my-5">
            <X onClick={() => close(false)} size={30} color="#fff" />
          </div>
          <img src={coin?.img} />
        </div>
      </motion.section>
